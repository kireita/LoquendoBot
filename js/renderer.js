const path = require('path'), // get directory path
    ...
    soundsFolder = './sounds/', // sound folder location
...
var say = new Say(),
    ...
    resolutions = fs.readFileSync('./config/resolutions.txt').toString().split("\r\n"), // read resolution file
    encodings = fs.readFileSync('./config/encodings.txt').toString().split("\r\n"), // read encoding file
